...
--
-- Banco de dados: `gustavolucianoestoque`
--
DROP DATABASE IF EXISTS `gustavolucianoestoque`;
CREATE DATABASE IF NOT EXISTS `gustavolucianoestoque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gustavolucianoestoque`;
...
CREATE TABLE `cliente` (
  `cod_cliente` int(11) NOT NULL COMMENT 'Esse campo armazena o codigo do cliente',
  `nome_cliente` varchar(50) DEFAULT NULL COMMENT 'Esse campo armazena o nome do cliente',
  `endereco` varchar(50) DEFAULT NULL COMMENT 'Esse campo armazena o endereço do cliente',
  `cidade` varchar(50) DEFAULT NULL COMMENT 'Esse campo armazena a cidade do cliente',
  `cep` varchar(10) DEFAULT NULL COMMENT 'Esse campo armazena o cep do cliente',
  `cnpj` varchar(30) DEFAULT NULL COMMENT 'Esse campo armazena o cnpj do cliente',
  `uf` varchar(2) DEFAULT NULL COMMENT 'Esse campo armazena a unidade federativa do cliente',
  `ie` int(10) DEFAULT NULL COMMENT 'Esse campo armazena a inscrição estadual do cliente'
...
(130, 'Edmar', 'Rua da Praia s/n', 'Salvador', '30079300', '234632842349', 'BA', 7121),
...
CREATE TABLE `item_de_pedido` (
  `num_pedido` int(11) NOT NULL COMMENT 'Esse campo armazena o numero do pedido',
  `cod_produto` int(11) NOT NULL COMMENT 'Esse campo armazena o código do produto',
  `qtde` int(11) NOT NULL COMMENT 'Esse campo armazena a quantidade'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `pedido` (
  `num_pedido` int(11) NOT NULL COMMENT 'Esse campo armazena o numero do pedido',
  `prazo_entrega` int(10) DEFAULT NULL COMMENT 'Esse campo armazena o prazo de entrega',
  `cod_cliente` int(11) DEFAULT NULL COMMENT 'Esse campo armazena o codigo do cliente',
  `cod_vendedor` int(11) DEFAULT NULL COMMENT 'Esse campo armazena o codigo do vendedor'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `produto` (
  `cod_produto` int(11) NOT NULL COMMENT 'Esse campo armazena o código do produto',
  `unid_produto` varchar(10) DEFAULT NULL COMMENT 'Esse camapo armazena a unidade de medida do produto',
  `desc_produto` varchar(50) DEFAULT NULL COMMENT 'Esse campo armazena a descrição do produto',
  `valor_unit` decimal(15,2) DEFAULT NULL COMMENT 'Esse campo armazena o valor unitário do produto'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `vendedor` (
  `cod_vendedor` int(11) NOT NULL COMMENT 'Esse campo armazena o codigo do vendedor',
  `nome_vendedor` varchar(50) DEFAULT NULL COMMENT 'Esse campo armazena o nome do vendedor',
  `sal_fixo` decimal(15,2) DEFAULT NULL COMMENT 'Esse campo armazena o salario fixo do vendedor',
  `faixa_comissao` char(2) DEFAULT NULL COMMENT 'Esse campo armazena a faixa de comissao do vendedor'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
